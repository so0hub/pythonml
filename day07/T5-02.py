...
# [*] 문자열에 대한 군집은 범주형이라서 힘들다. kmodes 모델 사용하거나 딥러닝 모델 사용.
...
# 벡터 구성 예
# 단순 빈도 계산
# [1] 2개의 문장이 존재한다는 가정                  ,   "사과 바나나 과일 식사" , "포도 멜론 단맛 과일" 
# [2] 전체 문장 나열하여 총7개 키워드/단어 추출       ,   사과,바나나,과일,식사,포도,멜론,단맛 
# [3] 첫 번째 문장이 7가지 키워드에 존재하는지 검토 , 존재하면 1 , 존재하지 않으면 0
#       사과,바나나,과일,식사,포도,멜론,단맛  --> 1 , 1 , 1 , 1 , 0 , 0 , 0
# [4] 두 번째 문장은 7가지 키워드에 존재하는지 검토2 , 존재하면 1  , 존재하지 않으면 0
