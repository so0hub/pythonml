...
print( iris_length , iris_width ) # 길이 , 너비
import matplotlib.pyplot as plt
plt.scatter( iris_length , iris_width )
plt.show()
...
print( train_input.shape ) # (35,) # 1차원

train_input = train_input.reshape( -1 , 1 ) 
print( train_input.shape ) # (35,1) # 2차원이 됐다
# ===========================================
test_input = np.array( test_input )
print( test_input.shape ) # (15,) # 1차원

test_input = test_input.reshape( -1 , 1 )
print( test_input.shape ) # (15,1) # 2차원이 됐다
