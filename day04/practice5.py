...
for degree in [ 1,2,3,4,5 ] :
    ...
    optimization.append( { 'r2' : r2 , 'model' : lr , 'poly' : poly , 'degree' : degree ,
    ...
    for alpha in [ 0.01 , 0.1 , 1 , 10 , 100 ] :
        ...
        optimization.append( { 'r2' : r2 , 'model' : ridge , 'poly' : poly , 'degree' : degree ,
        ...
        optimization.append( { 'r2' : r2 , 'model' : lasso , 'poly' : poly , 'degree' : degree ,
                          'scaler' : ss , 'alpha' : alpha } )            
...
print( f'최적의 모델명 : { best_model } , 다항특성 : { best_poly } , 스케일링 : { scaler } ' )
# 최적의 모델명 : Ridge(alpha=10) , 다항특성 : PolynomialFeatures(degree=3, include_bias=False) , 스케일링 : StandardScaler() 
