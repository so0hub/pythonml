...
# 특정한 아리리스 추출 , setosa , versicolor
Iris_setosa = df[ df['Species'] == 'Iris-setosa' ] # Iris-setosa
print( Iris_setosa.info ) # 1~50

Iris_versicolor = df[ df['Species'] == 'Iris-versicolor' ] #  Iris-versicolor
print( Iris_versicolor.info ) # 51~100
...
print( train_input.shape ) # ( 70 , 2 ) , 100개 중에 학습용 7에 해당하는 개수가 70개
print( test_input.shape ) # ( 30 , 2 ) , 100개 중에 테스트용 3에 해당하는 개수가 30개
...
# 어떤 품종으로 예측하는지 확인하세요.
print( kn.predict( [[2.0,0.5]] ) ) # [1.] setosa로 예측
